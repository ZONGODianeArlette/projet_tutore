<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="{{ route('public.index') }}" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Goom Biis</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->routeIs('lessons.index') ? 'active' : '' }} 
        || {{ request()->routeIs('lessons.create') ? 'active' : '' }} 
        || {{ request()->routeIs('lessons.show') ? 'active' : '' }}
        || {{ request()->routeIs('ajout-mot-moore') ? 'active' : '' }}">
        <a href="{{ route('lessons.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-right-indent"></i>
          <div data-i18n="Analytics">Gestion des leçons</div>
        </a>
      </li>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->routeIs('selection-lesson') ? 'active' : '' }}">
        <a href="{{ route('selection-lesson') }}" class="menu-link">
          ...
          <div data-i18n="Analytics">Selectionner des leçons</div>
        </a>
      </li>
      <li class="menu-item {{ request()->routeIs('mes-lessons') ? 'active' : '' }} || {{ request()->routeIs('apprentissage-index') ? 'active' : '' }}">
        <a href="{{ route('mes-lessons') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-list-ul"></i>
          <div data-i18n="Analytics">Mes leçons</div>
        </a>
      </li>
      <li class="menu-item {{ request()->routeIs('mes-scores') ? 'active' : '' }}">
        <a href="{{ route('mes-scores') }}" class="menu-link">
