...
<body>
  ...
  <div class="contact_section layout_padding padding_top_0" style="margin-top: 12vh;" >
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 ">
          ...
          <div class="" style="display: grid; justify-items:center"   >
                    <div class="input_main">
                       <div class="container" style="background-color: rgba(218, 215, 213, 0.747); box-shadow: 0px 8px 16px 0px rgba(0, 0, 0, 0.6);">
                          ...
                          <form action="/action_page.php" >
                            ...
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Entrer le mot singulier</label>
                              <input type="text" class="form-control" id="exampleInputEmail1">
                            </div>                           
                          </form>  
                          <div class="btn btn-primary mb-2 " style="margin-left: 15px; "  ><a href="#">Ajouter</a></div>                  
                    </div> 
                       </div> 
